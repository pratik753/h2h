      ...
      <div className="bg-indigo-100 dark:bg-gray-800 overflow-hidden relative lg:flex lg:items-center">
        <div className="w-full py-12 px-4 sm:px-6 lg:py-10 lg:px-8 z-20">
          <h2 className="text-4xl font-extrabold text-gray-800 dark:text-white sm:text-4xl">
            <span className="block">Full Spectrum of Solutions</span>
          </h2>
          <p className="text-md mt-4 text-gray-400">
            From advanced medical devices, hemorrhage management and wound care,
            to innovations in negative pressure wound therapy, Raymedis is the
            go-to solutions provider for medical suppliers and practitioners
            addressing the challenges of people’s healthcare. We combine good
            design, impeccable materials.
          </p>
          ...
          <div className="flex justify-between items-center gap-8 mb-4 sm:mb-8 md:mb-12">
            <div className="flex items-center gap-12">
              ...
              <p className="max-w-screen-sm hidden md:block text-gray-500">
                Heal2Health supplies various wound dressings that provide
                balanced moisture environment on wound bed.
              </p>
            </div>

            <a
              href="#"
              className="inline-block bg-blue-500 hover:bg-blue-600 active:bg-blue-500 focus-visible:ring ring-indigo-300 border text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-4 md:px-8 py-2 md:py-3"
            >
              More
            </a>
          </div>
