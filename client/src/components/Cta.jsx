      ...
      <aside>
        <div className="px-4 py-8 mx-auto max-w-screen-2xl sm:px-6  lg:px-8">
          <div className="grid grid-cols-1  gap-4 md:grid-cols-2">
            <div className="p-8 bg-indigo-600 md:p-12 rounded-lg lg:px-16 lg:py-24">
              <div className="max-w-xl mx-auto text-center">
                ...
                <div className="mt-4 md:mt-8">
                  <a
                    href="#"
                    className="inline-block px-12 py-3 tracking-normal text-md  open-sans font-medium text-indigo-500 bg-white border border-white rounded transition hover:bg-transparent hover:text-white focus:outline-none focus:ring focus:ring-white"
                  >
                    Learn More
                  </a>
                </div>
