...
import { useDispatch,useSelector } from "react-redux";
 import { CircularProgress, getListItemSecondaryActionClassesUtilityClass } from '@mui/material';
...
function List() {
 ...
 async function f1(e)
 {
  ...
  console.log("hello from f1 side");
  console.log(e.target.attributes[0].nodeValue);
  let email=e.target.attributes[0].nodeValue;
 // dispatch(getParticularpres(email));
 e.preventDefault();
 ...
 const val=await API.get(`/api/products/getpres/${email}`);
 ...
 console.log(datas);
          ...
          <tbody>
           ...
           <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" >
              ...
              >
                ...
                />
                <div className="pl-3">
                  <div className="text-base font-semibold">{expense.name}</div>
              ...
              <td className="py-4 px-6">
                ...
                <button lable={expense.email} onClick={f1} class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="button" data-drawer-target="drawer-form" data-drawer-show="drawer-form" aria-controls="drawer-form">
                 SHOW
                </button>
              </td>
  ...
  :(
    !data.length ? <h1>NO PRODUCT TO SHOW</h1> :(
      <div>
   ...
   {image===true && <div className="flex items-center min-h-screen px-12 py-12">
        ...
        {data.map((expense)=>
                         ...
                         {expense.id1==id2&& expense.img.map((exp)=>
...
{images===true&&<div className="flex items-center min-h-screen px-12 py-12">
   ...
   {datas.map((expense)=>
       ...
       {expense.length >1 &&<td className="py-4 px-6">{expense.length}</td>}
 ...
 {(image==false && images==false) && <div className="flex items-center min-h-screen px-12 py-12">
   ...
   {data.map((expense)=>
       ...
       <button lable={expense.id1}  onClick={f10}
       ...
       <td className="py-4 px-6">{Math.floor((Math.random() * 100000) + 1)}</td>
       <td className="py-4 px-6">{expense.reimbersement}</td>
       <td className="py-4 px-6">
       <button lable={expense.id1}  onClick={f12}
