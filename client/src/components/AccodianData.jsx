...
export const AccodianData = () => {
  ...
  console.log(value);
  return (
  <div className=" py-8 md:py-10  mx-auto w-full overflow-x-auto ">
      <div className="w-full sm:mx-auto lg:max-w-full">
...
<div date-rangepicker="" className="flex items-center">
  <div className="relative">
    ...
    <input id="start" type="text" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 datepicker-input" placeholder="Start date (DD/MM/YYYY)"/>
  </div>
    ...
    <input id="end" type="text" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 datepicker-input" placeholder="End date  (DD/MM/YYYY)"/>
        ...
        >
          SHOW
           ...
           {value.length==0?<CircularProgress></CircularProgress>: <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 overflow-x-auto">
              <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                  <th scope="col" className="md:py-3 md:px-6 py-2 ">
                    <ImageIcon />
                  </th>
                  <th scope="col" className="md:py-3 md:px-6 py-2 px-3">
                    items ID
                  </th>
                  <th scope="col" className="md:py-3 md:px-6 py-2 px-3">
                    Date
              ...
              <tbody>
              {value.map((product) => ( <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  <th 
                    scope="row"
                    className="md:py-4 md:px-6 font-medium text-gray-900 whitespace-nowrap cursor-pointer  dark:text-white"
                  >
                    <AttachmentIcon />
                  </th>
       
                  <td className="md:py-4 md:px-6 py-2 px-3">{Math.floor((Math.random() * 100000) + 1)}</td>
                  <td className="md:py-4 md:px-6 py-2 px-3">{product.dat.substring(11)}</td>
                  <td className="md:py-4 md:px-6 py-2 px-3">{product.reimbersement}</td>
                </tr>
              ))}
              </tbody>
            </table>}
