...
export const getAllOrder = () => API.get("/api/products/orders");
export const getPartData = (data) => API.get(`/api/products/getpart/${data}`);
export const getParticularpresc = (data) =>
  API.get(`/api/products/getpres/${data}`);
export const getParticularDate = (data) =>
  API.post(`/api/products/getdate`, data);
